...
if(isset($_SESSION['note'])){
    ...
    switch ($_SESSION['note']) {
      ...
      case 'succSaveReview':
        $alert    = "alert-success";
        $mess     = "Berhasil menambahkan review.";
      break;
      case 'appSucceed':
        $alert    = "alert-success";
        ...
        <div class="col-md-5 col-md-offset-1">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" readonly value="<?=$key?>" placeholder="Kata kunci untuk nama / aktivitas..." name="key">
            </div><!-- /.input group -->
          </div><!-- /.form group -->
        </div>
        <div class="col-md-5">
          ...
          <table id="ordersTable" class="table table-bordered table-striped table-hover">
            <thead>
              <tr>
                ...
                <th class="text-center" width="150px">Tanggal Aktivitas</th>
            ...
            <tbody>
            <?php $no = 0; foreach ($tasks as $key => $task) { $no = $key+1; ?>
              <tr>

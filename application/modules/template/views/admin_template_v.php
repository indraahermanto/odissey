  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php if(!isset($url[2]) && $url[1] == 'admin') echo 'active' ?>">
              <a href="<?=base_url().'admin'?>"><i class="fa fa-home"></i> <span>Home</span></a>
            </li>
            <?=$adv_menu
            /*
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="http://siimanto.com">Siimanto [dot] com</a>.</strong><br/>All rights reserved.
      </footer>

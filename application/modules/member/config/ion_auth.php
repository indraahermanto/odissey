...
*/
$config['tables']['users']           = 'od_user';
$config['tables']['groups']          = 'od_user_level';
$config['tables']['users_groups']    = 'od_user_mod';
 ...
 */
$config['site_title']                 = "siimanto.com";       // Site Title, example.com
$config['admin_email']                = "no-reply@siimanto.com"; // Admin Email, admin@example.com

            ...
            <div class="input-group">
              <div class="input-group-btn">
                ...
                <ul class="dropdown-menu">
                  <li><a href="<?=base_url().'snba/invoices/?f=all'?>">All</a></li>
                  <?php
                  foreach ($listStatus as $status) {
                    echo "<li><a href='".base_url()."snba/invoices/?f=$status->stat_id'>".ucwords($status->stat_name)."</a></li>";
                  }
                  ?>
                </ul>
              </div><!-- /btn-group -->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <?="<a href='".base_url().'snba/invoices/preview/'.sha1($this->config->config['salt'].$invoice->inv_number)

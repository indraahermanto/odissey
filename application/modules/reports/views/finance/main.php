            ...
            <div class="input-group">
              <div class="input-group-btn">
                ...
                <ul class="dropdown-menu">
                  <li><a href="<?=base_url().'finance/reports/?f=all'?>">All</a></li>
                  <?php
                  foreach ($listStatus as $status) {
                    echo "<li><a href='".base_url()."finance/reports/?f=$status->stat_id'>".ucwords($status->stat_name)."</a></li>";
                  }
                  ?>
                </ul>
              </div><!-- /btn-group -->
          ...
          <table id="ordersTable" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"><?="<a href='".base_url().'finance/reports/preview/'.sha1($this->config->config['salt'].$report->number)."'>$report->number</a>"?></td>
          ...
          <div class="row">
            ...
            <div class="col-md-1">
              <!-- <div class="input-group-btn"> -->
                ...
                <form method="POST" action="<?=base_url().'finance/reports/preview/new'?>">
